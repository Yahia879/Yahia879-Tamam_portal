...
--> statement-breakpoint
ALTER TABLE `disbursement_orders` DROP FOREIGN KEY `disbursement_orders_disburseme_Id_disbursement_requests_id_fk`;
--> statement-breakpoint
...
ALTER TABLE `contract_modification_logs` ADD CONSTRAINT `cml_contract_fk` FOREIGN KEY (`contractId`) REFERENCES `contracts_enhanced`(`id`) ON DELETE no action ON UPDAT_tement-breakpoint
ALTER TABLE `contract_modification_logs` ADD CONSTRAINT `cml_modreq_fk` FOREIGN KEY (`modificationRequestId`) REFERENCES `contract_modification_requests`(`id`) ON DELETE no action ON UPDAT_tement-breakpoint
ALTER TABLE `contract_modification_logs` ADD CONSTRAINT `cml_user_fk` FOREIGN KEY (`modifiedBy`) REFERENCES `users`(`id`) ON DELETE no action ON UPDAT_tement-breakpoint
ALTER TABLE `contract_modification_requests` ADD CONSTRAINT `cmr_contract_fk` FOREIGN KEY (`contractId`) REFERENCES `contracts_enhanced`(`id`) ON DELETE no action ON UPDAT_tement-breakpoint
ALTER TABLE `contract_modification_requests` ADD CONSTRAINT `cmr_requested_fk` FOREIGN KEY (`requestedBy`) REFERENCES `users`(`id`) ON DELETE no action ON UPDAT_tement-breakpoint
ALTER TABLE `contract_modification_requests` ADD CONSTRAINT `cmr_reviewed_fk` FOREIGN KEY (`reviewedBy`) REFERENCES `users`(`id`) ON DELETE no action ON UPDAT_tement-breakpoint
ALTER TABLE `disbursement_orders` ADD CONSTRAINT `do_req_fk` FOREIGN KEY (`disbursementRequestId`) REFERENCES `disbursement_requests`(`id`) ON DELETE no action ON UPDATE no action;