...
export default function RequesterPendingScreen() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-slate-50 via-slate-100 to-primary/5 dark:from-slate-950 dark:via-slate-900 dark:to-primary/5 font-sans text-right relative overflow-hidden" dir="rtl">
