      ...
      {basketItems.length > 0 && (
        <div className="bg-white dark:bg-slate-800/50 p-4 rounded-xl border border-border/80 shadow-xs space-y-3">
          <div className="flex items-center justify-between">
            ...
            {hasApprovedPlan && (
              <span className="text-[10px] font-bold text-cyan-700 bg-cyan-50 dark:bg-cyan-950/40 px-2.5 py-0.5 rounded-full border border-cyan-200 dark:border-cyan-800 flex items-center gap-1">
                ...
                {basketItems.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-muted/10">
                      ...
                      {hasApprovedPlan && (
                        <td className="p-2.5 text-center font-bold text-cyan-600">
      ...
      {funding && (
        <div className="bg-gradient-to-br from-indigo-50/60 to-purple-50/40 dark:from-indigo-950/30 dark:to-purple-950/20 p-4 rounded-xl border border-indigo-200 dark:border-indigo-900 space-y-3">
          ...
          {funding.fundingPath === 'direct_purchase' && funding.directDonorInfo && (
            <div className="p-3 rounded-xl bg-cyan-50/70 dark:bg-cyan-950/30 border border-cyan-200 dark:border-cyan-800 text-xs space-y-1.5">
                ...
                {funding.directDonorInfo.receiptFileUrl && (
                  <div>
                    <a
                      ...
                      className="text-cyan-700 dark:text-cyan-400 font-bold hover:underline inline-flex items-center gap-1"
                    >
          ...
          {funding.procurementMode && (
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs flex items-center justify-between">
              ...
              <span className="font-bold text-cyan-700 dark:text-cyan-400 bg-cyan-100 dark:bg-cyan-950 px-2.5 py-0.5 rounded-md">
