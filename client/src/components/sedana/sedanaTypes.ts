...
export const getDefaultBasketItems = (
  mosqueArea: number = 250,
  worshippers: number = 150,
  ...
  const items: SedanaBasketItem[] = [
    // 1. العمالة
    {
      ...
      quantity: worshippers > 350 || mosqueArea > 600 ? 24 : 12,
      unit: 'شهر',
      frequency: 'شهري',
    },
    {
    ...
    // 2. مواد النظافة
    {
      ...
      quantity: Math.max(8, Math.round(worshippers * 0.1)),
      unit: 'جالون',
      frequency: 'ربع سنوي',
    },
    {
      ...
      quantity: Math.max(16, Math.round(worshippers * 0.18)),
      unit: 'عبوة',
      frequency: 'ربع سنوي',
    },
    {
      ...
      quantity: Math.max(16, Math.round(mosqueArea * 0.1)),
      unit: 'جالون',
      frequency: 'ربع سنوي',
    },
    ...
    // 3. المعطرات
    {
      ...
      quantity: Math.max(1, Math.round(mosqueArea / 100)),
      unit: 'جهاز',
      frequency: 'نصف سنوي',
    },
    {
      ...
      quantity: Math.max(2, Math.round(mosqueArea / 100) * 2),
      unit: 'عبوة',
      frequency: 'نصف سنوي',
    },
    ...
    // 4. سقيا الماء
    {
      ...
      quantity: Math.max(60, Math.round(worshippers * 1.8)),
      unit: 'كرتون',
      frequency: 'شهري',
    },
    ...
    // 5. البلاستيكيات
    {
      ...
      quantity: Math.max(16, Math.round(worshippers * 0.15 + mosqueArea * 0.04)),
      unit: 'كرتون',
      frequency: 'ربع سنوي',
    },
    {
      ...
      quantity: Math.max(12, Math.round(worshippers * 0.1)),
      unit: 'كرتون',
      frequency: 'شهري',
    },
    {
      ...
      quantity: Math.max(24, Math.round(worshippers * 0.85)),
      unit: 'كرتون',
      frequency: 'شهري',
    },
