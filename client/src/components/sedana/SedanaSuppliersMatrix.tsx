...
export const SedanaSuppliersMatrix: React.FC<SedanaSuppliersMatrixProps> = ({
  ...
  return (
    <div className="space-y-5 p-5 rounded-2xl border border-border/80 bg-card text-right shadow-xs" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-border/70 gap-3">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-cyan-100 text-cyan-800 dark:bg-cyan-950/60 dark:text-cyan-300">
              المحطة 3
            </span>
        ...
        {isAlreadySaved && (
          <span className="text-xs font-bold text-cyan-700 bg-cyan-50 dark:bg-cyan-950/40 px-3 py-1.5 rounded-full border border-cyan-200 dark:border-cyan-800 self-start sm:self-center flex items-center gap-1.5 shrink-0">
      ...
      <div className="p-4 rounded-xl bg-gradient-to-r from-cyan-500/10 via-sky-500/10 to-cyan-500/10 border border-cyan-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <span className="text-xs text-muted-foreground font-semibold block">إجمالي التكلفة الفعلية الشاملة للمسجد (Base Cost):</span>
          <span className="text-3xl font-extrabold text-cyan-700 dark:text-cyan-400 font-mono tracking-tight">
        ...
        <div className="text-right sm:max-w-xs space-y-1">
          ...
          <span className="text-[11px] text-cyan-700 dark:text-cyan-400 font-bold block">
      ...
      {canEdit && (
        <div className="flex flex-col sm:flex-row items-center justify-end gap-2.5 pt-3 border-t border-border/70">
          ...
          <Button
            ...
            className="w-full sm:w-auto bg-cyan-600 hover:bg-cyan-700 text-white text-xs h-10 px-5 gap-2 font-bold shadow-xs"
          >
