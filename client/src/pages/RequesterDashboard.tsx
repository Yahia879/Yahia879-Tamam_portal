...
export default function RequesterDashboard() {
  ...
  return (
    <BeneficiaryLayout activeTab="dashboard">
      {/* Hero Welcome Banner */}
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-l from-primary/95 via-primary to-emerald-900 dark:from-emerald-900 dark:via-primary/90 dark:to-emerald-950 text-white p-5 sm:p-8 lg:p-10 mb-6 sm:mb-8 shadow-xl border border-white/10 dark:border-emerald-800/40">
