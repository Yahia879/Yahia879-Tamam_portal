...
export default function RequesterDashboard() {
  ...
  return (
    <BeneficiaryLayout activeTab="dashboard">
      {/* Hero Welcome Banner */}
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-l from-primary/95 via-primary to-emerald-900 text-white p-5 sm:p-8 lg:p-10 mb-6 sm:mb-8 shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-5 sm:gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 w-full md:w-auto shrink-0 pt-2 sm:pt-0">
            <Link href="/request-form-dynamic" className="w-full">
              <Button size="lg" className="w-full rounded-xl sm:rounded-2xl bg-white text-primary hover:bg-white/95 font-bold shadow-lg gap-2 h-11 sm:h-12 text-xs sm:text-sm cursor-pointer">
                <Plus className="w-4 h-4 sm:w-5 sm:h-5" />
                <span>تقديم طلب جديد</span>
              </Button>
            </Link>
            <Link href="/requester/mosques/new" className="w-full">
              <Button size="lg" variant="outline" className="w-full rounded-xl sm:rounded-2xl border-white/40 bg-white/10 text-white hover:bg-white/20 font-bold backdrop-blur-md gap-2 h-11 sm:h-12 text-xs sm:text-sm cursor-pointer">
      ...
      {user?.status === "pending" && (
        <div className="mb-6 sm:mb-8 dir-rtl">
          <Alert className="border-amber-200 bg-amber-50/80 dark:bg-amber-950/30 dark:border-amber-900/40 text-amber-900 dark:text-amber-200 rounded-2xl p-4 shadow-xs flex items-start gap-3 sm:gap-4">
            <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
            <div className="space-y-1">
              <AlertTitle className="font-bold text-sm sm:text-base">حسابك قيد المراجعة حالياً</AlertTitle>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
        <Link href="/my-requests">
          <Card className="border border-border/60 shadow-xs hover:shadow-md transition-all rounded-xl sm:rounded-2xl cursor-pointer group bg-background">
            <CardContent className="p-3 sm:p-5 flex items-center justify-between gap-2">
              ...
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-primary/10 flex items-center justify-center text-primary shrink-0 group-hover:scale-110 transition-transform">
          ...
          <Card className="border border-border/60 shadow-xs hover:shadow-md transition-all rounded-xl sm:rounded-2xl cursor-pointer group bg-background">
            <CardContent className="p-3 sm:p-5 flex items-center justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="text-xl sm:text-3xl font-extrabold text-amber-600 mt-0.5 sm:mt-1">
                  {stats.pending}
                </p>
              </div>
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-amber-500/10 flex items-center justify-center text-amber-600 shrink-0 group-hover:scale-110 transition-transform">
          ...
          <Card className="border border-border/60 shadow-xs hover:shadow-md transition-all rounded-xl sm:rounded-2xl cursor-pointer group bg-background">
            <CardContent className="p-3 sm:p-5 flex items-center justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="text-xl sm:text-3xl font-extrabold text-blue-600 mt-0.5 sm:mt-1">
                  {stats.inProgress}
                </p>
              </div>
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-blue-500/10 flex items-center justify-center text-blue-600 shrink-0 group-hover:scale-110 transition-transform">
          ...
          <Card className="border border-border/60 shadow-xs hover:shadow-md transition-all rounded-xl sm:rounded-2xl cursor-pointer group bg-background">
            <CardContent className="p-3 sm:p-5 flex items-center justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="text-xl sm:text-3xl font-extrabold text-emerald-600 mt-0.5 sm:mt-1">
                  {stats.completed}
                </p>
              </div>
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-600 shrink-0 group-hover:scale-110 transition-transform">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <Card className="lg:col-span-2 border border-border/60 shadow-xs rounded-2xl sm:rounded-3xl overflow-hidden bg-background">
          <CardHeader className="p-4 sm:p-6 border-b border-border/40">
            <div className="flex items-center justify-between gap-2">
              ...
              <Link href="/my-requests">
                <Button variant="ghost" size="sm" className="rounded-xl text-xs gap-1 font-semibold px-2 sm:px-3">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <Card className="border border-border/60 shadow-xs rounded-2xl sm:rounded-3xl overflow-hidden bg-background">
            <CardHeader className="p-4 sm:p-5 border-b border-border/40">
              <div className="flex items-center justify-between">
                ...
                <Link href="/my-mosques">
                  <Button variant="ghost" size="sm" className="rounded-xl text-xs font-semibold px-2.5">
                    <span>الكل</span>
                    <ChevronLeft className="w-3.5 h-3.5" />
                  </Button>
                </Link>
                ...
                <div className="space-y-3">
                  {myMosques.slice(0, 3).map((mosque) => (
                    <Link key={mosque.id} href={`/mosques/${mosque.id}`}>
                      <div className="p-3 sm:p-3.5 rounded-2xl bg-muted/30 hover:bg-muted/60 transition-all cursor-pointer border border-border/40 flex items-center justify-between gap-3 group">
                        <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-primary/10 text-primary flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                            <Building2 className="w-4 h-4 sm:w-5 sm:h-5" />
                          </div>
                          <div className="min-w-0">
                  ...
                  <Link href="/requester/mosques/new" className="block pt-2">
                    <Button variant="outline" className="w-full rounded-2xl text-xs font-semibold gap-2 border-dashed h-10 cursor-pointer">
                      <Plus className="w-4 h-4" />
