...
export default function NotificationCustomization() {
  ...
  const NOTIFICATION_TRIGGERS = [
    ...
    },
    {
      ...
      description: 'تم تحويل أمر الصرف رقم "DO-2026-0023" للمشروع "ترميم جامع النور" للاعتماد المالي بقيمة 50,000 ريال',
      defaultTemplate: "تم تحويل أمر الصرف رقم \"{رقم_أمر_الصرف}\" للمشروع \"{اسم_المشروع}\" للاعتماد المالي بقيمة {القيمة} ريال",
      variables: [
        { placeholder: "{رقم_أمر_الصرف}", nameAr: "رقم أمر الصرف" },
        { placeholder: "{اسم_المشروع}", nameAr: "اسم المشروع" },
        { placeholder: "{القيمة}", nameAr: "القيمة" },
