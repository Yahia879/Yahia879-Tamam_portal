    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50/70 p-3 sm:p-6 md:p-8" dir="rtl">
      <div className="w-full max-w-2xl">
        ...
        <Link href="/" className="flex flex-col items-center mb-6 sm:mb-8 text-center group cursor-pointer">
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-1">نموذج التسجيل وتقديم الطلبات والتبرعات</p>
        </Link>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2">
                  ...
                  <button
                    ...
                    className="p-4 sm:p-5 rounded-2xl border-2 border-slate-200 hover:border-teal-600 hover:bg-teal-50/40 text-right transition-all flex items-start gap-3.5 group cursor-pointer shadow-sm hover:shadow"
                  >
                  ...
                  <button
                    ...
                    className="p-4 sm:p-5 rounded-2xl border-2 border-slate-200 hover:border-indigo-600 hover:bg-indigo-50/40 text-right transition-all flex items-start gap-3.5 group cursor-pointer shadow-sm hover:shadow"
                  >
