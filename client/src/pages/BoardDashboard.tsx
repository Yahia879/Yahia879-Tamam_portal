        ...
        {isChairmanView && data?.chairmanData && (
          <div className="space-y-6 animate-in fade-in-50 duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <Card className="rounded-xl sm:rounded-2xl border-0 py-0 gap-0 shadow-xs bg-background hover:shadow-md transition-shadow relative overflow-hidden">
                <CardContent className="p-3.5 sm:p-4 flex items-center justify-between text-right">
                  <div className="space-y-1 min-w-0">
                    <p className="text-xs sm:text-sm font-bold text-muted-foreground">إجمالي الأوامر المعتمدة</p>
                    <h3 className="text-xl sm:text-2xl font-black text-foreground">
                      {data.chairmanData.totalApprovedCount}
                    </h3>
                  </div>
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900/50 text-emerald-600 shrink-0">
              ...
              <Card className="rounded-xl sm:rounded-2xl border-0 py-0 gap-0 shadow-xs bg-background hover:shadow-md transition-shadow relative overflow-hidden">
                <CardContent className="p-3.5 sm:p-4 flex items-center justify-between text-right">
                  <div className="space-y-1 min-w-0">
                    <p className="text-xs sm:text-sm font-bold text-muted-foreground">أوامر مرتبطة بطلبات معتمدة</p>
                  ...
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900/50 text-blue-600 shrink-0">
              ...
              <Card className="rounded-xl sm:rounded-2xl border-0 py-0 gap-0 shadow-xs bg-background hover:shadow-md transition-shadow relative overflow-hidden">
                <CardContent className="p-3.5 sm:p-4 flex items-center justify-between text-right">
                  <div className="space-y-1 min-w-0">
                    <p className="text-xs sm:text-sm font-bold text-muted-foreground">أوامر صرف مخصصة</p>
                  ...
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-900/50 text-purple-600 shrink-0">
