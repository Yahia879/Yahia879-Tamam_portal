          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
            <div className="space-y-2 text-right">
              <div className="flex items-center gap-3 justify-start">
                {isChairmanView ? (
                  <Badge className="bg-amber-500/15 text-amber-800 dark:text-amber-300 border border-amber-400/40 px-3 py-1 text-xs font-bold rounded-lg flex items-center gap-1.5 hover:bg-amber-500/20 transition-colors shadow-xs">
                ...
                <span className="text-xs text-muted-foreground flex items-center gap-1 font-medium bg-muted/60 px-2.5 py-0.5 rounded-full border border-border/40">
              ...
              <p className="text-xs text-muted-foreground/80 max-w-2xl leading-relaxed">
                {isChairmanView
                  ...
                  : "صفحة إحصائية خاصة بأعضاء مجلس الإدارة توفر اطلاعاً شاملاً وعميقاً على مؤشرات المساجد والطلبات والمشاريع والمالية."}
              </p>
            </div>
