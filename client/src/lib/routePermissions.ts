...
export const ROUTE_PERMISSION_MAP: Record<string, string | string[]> = {
  ...
  "/forms-customization": ["forms_customization.evaluation", "forms_customization.services", "forms_customization.registration", "forms_customization.analytics", "settings_center"],
