...
export const USER_ROLES = {
  ...
  board_chairman: { key: 'board_chairman', label: 'رئيس مجلس الإدارة', labelEn: 'Board Chairman' },
  board_member: { key: 'board_member', label: 'عضو مجلس الإدارة', labelEn: 'Board Member' },
...
export const ACTION_CONFIGS: Record<string, ActionConfig> = {
  ...
  closed: {
    ...
    actionButton: {
      ...
      redirectUrl: "/final-report/:reportId?requestId=:requestId",
    },
    allowedRoles: ["super_admin", "system_admin", "projects_office"],
  },
} as const;
...
export const SEDANA_WORKFLOW = [
  ...
  { id: "contracting", label: "اعتماد نوع التوريد", order: 4 },
